...
func reduce(acc int) func (_x *_state_0, l *_state_1) {
 return func (c *_state_0, l *_state_1){
for {
 label := l.Recv()
switch label {
...
func doMap()func (_x *_state_1, l *_state_1, r *_state_1) {
 return func (c *_state_1, l *_state_1, r *_state_1){
for {
 label := l.Recv()
switch label {
case "cons" :
...
l_0 := l_.(*_state_1)
l2.Recv()
r_ := init_state_1(make(chan interface{}))
go cons(((n * 2) + 1))(r_, r)
//Update arguments
//Update channels
c = c
...
switch cr {
case "null":
r0 := r.ls["null"].(*_state_0)
c0 := c.ls["null"].(*_state_0)
r0.Recv()
c0.Send(nil)
return
case "cons":
...
func cons(v int) func (_x *_state_1, l *_state_1) {
 return func (c *_state_1, l *_state_1){
c.Send("cons")
c0 := c.ls["cons"].(*_state_2)
c1 := c0.Send(v)
l_ := init_state_1(make(chan interface{}))
go func (l_ *_state_1, l *_state_1){
// FWD l_ l Start
for {
l_l := l.Recv()
l_.Send(l_l)
...
func (c *_state_0){
e0 := init_state_1(make(chan interface{}))
go null()(e0)
e1 := init_state_1(make(chan interface{}))
go cons(1)(e1, e0)
e2 := init_state_1(make(chan interface{}))
go cons(2)(e2, e1)
e3 := init_state_1(make(chan interface{}))
go cons(3)(e3, e2)
m := init_state_1(make(chan interface{}))
go null()(m)
doMapC := init_state_1(make(chan interface{}))
go doMap()(doMapC, e3, m)
result := init_state_0(make(chan interface{}))
go reduce(0)(result, doMapC)
result.Recv()
l1 := init_state_1(make(chan interface{}))
go null()(l1)
l2 := init_state_1(make(chan interface{}))
go cons(2)(l2, l1)
l3 := init_state_1(make(chan interface{}))
go cons(4)(l3, l2)
l4 := init_state_1(make(chan interface{}))
go cons(8)(l4, l3)
l5 := init_state_1(make(chan interface{}))
go cons(16)(l5, l4)
l6 := init_state_1(make(chan interface{}))
go cons(32)(l6, l5)
m1 := init_state_1(make(chan interface{}))
go null()(m1)
map1 := init_state_1(make(chan interface{}))
go doMap()(map1, l6, m1)
r := init_state_0(make(chan interface{}))
go reduce(0)(r, map1)
r.Recv()
c.Send(nil)
}(c)
